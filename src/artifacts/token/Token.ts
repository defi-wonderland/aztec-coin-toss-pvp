...
export const TokenContractArtifact =
  TokenContractArtifactJson as ContractArtifact;
...
export class TokenContract extends ContractBase {
  ...
  public methods!: {
    ...
    _reduce_total_supply: ((amount: FieldLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, "selector">;
    ...
    broadcast_escrow_note_for: ((
      accounts: AztecAddressLike[],
    ...
    get_escrow: ((randomness: FieldLike) => ContractFunctionInteraction) &
      Pick<ContractMethod, "selector">;

    /** get_escrows(offset: integer) */
    get_escrows: ((offset: bigint | number) => ContractFunctionInteraction) &
      Pick<ContractMethod, "selector">;
    ...
    /** settle_escrow(owner: struct, recipient: struct, randomness: field, nonce: field) */
    settle_escrow: ((
      owner: AztecAddressLike,
